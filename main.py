...
# Проверяющие
reviewer_1 = Reviewer('Николай', 'Дмитриевский')
reviewer_1.courses_attached += ['Python']

reviewer_2 = Reviewer('Вячеслав', 'Мисин')
